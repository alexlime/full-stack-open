describe("Blog app", function () {
  ...
  describe("When logged in", function () {
    ...
    it("The blogs are ordered according to likes", function () {
      ...
      cy.contains("Most likes").get("button").contains("show").click();

      cy.contains("Second most likes").get("button").contains("show").click();

      cy.contains("Third most likes").get("button").contains("show").click();
